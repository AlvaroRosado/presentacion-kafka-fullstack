 ...
 *             capabilities?: list<input-audio|input-image|input-messages|input-multiple|input-pdf|input-text|input-multimodal|output-audio|output-image|output-streaming|output-structured|output-text|tool-calling|text-to-speech|speech-to-text>,
 *         }>>,
